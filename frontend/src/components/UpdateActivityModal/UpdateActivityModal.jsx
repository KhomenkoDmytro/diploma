...
import style from './UpdateActivityModal.module.scss';
...
const UpdateActivityModal = ({ isOpen, onClose, onUpdate, activity }) => {
  ...
  return (
    <Modal
      ...
      contentLabel="Оновити Активність"
      className={style.modal}
      overlayClassName={style.overlay}
    >
      <h2>Оновити Активність</h2>
